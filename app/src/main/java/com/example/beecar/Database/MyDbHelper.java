...
public class MyDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String tb_vehicles = "create table if not exists tb_vehicles (id integer primary key autoincrement,image_car int,name_car string,price_time int ,price_date int , id_category references tb_category(id)) ";
        ...
        String tb_driver = "create table if not exists  tb_driver (id integer primary key autoincrement, user_name string,password string,full_name string,status_driver int , user_id references tb_user(id))";
