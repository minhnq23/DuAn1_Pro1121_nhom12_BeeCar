...
public class MyDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String tb_vehicles = "create table if not exists tb_vehicles (id integer primary key autoincrement,image_car blog,name_car string, bien_ks string,count_muon int,price_time int ,price_date int,day_bd date, day_dk date,id_category references tb_category(id)) ";
